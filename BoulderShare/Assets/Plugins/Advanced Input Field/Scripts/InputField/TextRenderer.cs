...
namespace AdvancedInputFieldPlugin
{
	...
	public struct RichTextTagInfo
	{
		...
		public RichTextTagInfo(RichTextTagType type, string startTag, string endTag)
		{
			...
			if(type == RichTextTagType.SINGLE_PARAMETER)
			{
	...
	public enum RichTextTagType { BASIC, SINGLE_PARAMETER }
	...
	{
		private const string NOT_CONFIGURED_ERROR = "This type of Text Renderer is not configured, please check the ReadMe for instructions.";
