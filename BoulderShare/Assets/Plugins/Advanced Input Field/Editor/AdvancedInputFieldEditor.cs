...
namespace AdvancedInputFieldPlugin.Editor
{
	...
	public class AdvancedInputFieldEditor: UnityEditor.Editor
	{
		...
		private void OnEnable()
		{
			...
			normalColorProperty = serializedObject.FindProperty("m_Colors").FindPropertyRelative("m_NormalColor");
			disabledColorProperty = serializedObject.FindProperty("m_Colors").FindPropertyRelative("m_DisabledColor");
