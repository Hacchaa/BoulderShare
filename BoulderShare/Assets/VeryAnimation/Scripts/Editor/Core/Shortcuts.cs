...
namespace VeryAnimation
{
    public static class Shortcuts
    {
        ...
        [Shortcut(hideSelectBones, typeof(VeryAnimationEditorWindow), KeyCode.N)]
        ...
        [Shortcut(showSelectBones, typeof(VeryAnimationEditorWindow), KeyCode.N, ShortcutModifiers.Shift)]
